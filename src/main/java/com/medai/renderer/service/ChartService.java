...
/**
 * Publication-quality clinical chart renderer — pure Java2D.
 * Generates KM curves, Swimmer plots, Waterfall plots, Forest plots, Bar charts.
 * v3.0 — Complete rewrite from JFreeChart for pixel-perfect control.
 */
@Service
public class ChartService {
    ...
    // ═════════════════════════════════════════════
    // 1. KAPLAN-MEIER with At-Risk, Censoring, HR Box
    // ═════════════════════════════════════════════
